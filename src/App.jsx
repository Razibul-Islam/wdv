...
function App() {
  return (
    <div className="bg-[#1E1E1E] text-white h-full lg:h-screen">
      <CustomCursor />
      <p className="text-center font-bold">Choose the best</p>
      <h1 className="text-3xl lg:text-6xl text-center font-bold max-w-5xl mx-auto mt-6 mb-24">
      ...
      <div className="grid grid-cols-1 px-3 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-[1400px] mx-auto">
        ...
        >
          <p className="p-8 absolute z-10 bg-[#312727] -top-10 left-10 rounded-full">
            <User className="scale-150 text-purple-500 group-hover:text-yellow-400" />
          </p>
          ...
          <div className="z-10 p-8 mt-8 sticky">
            <h3 className="text-[28px] font-semibold">
              Competitive <span className="text-purple-500">Analysis</span>
            </h3>
        ...
        >
          <p className="p-8 absolute z-10 bg-[#312727] -top-10 left-10 rounded-full">
            <ChartBar className="scale-150 text-purple-500 group-hover:text-yellow-400" />
          </p>
          <div className="absolute w-0 h-0 group-hover:w-full group-hover:h-full group-hover:bg-black rounded-tl-[30px] rounded-br-[30px] transition-all duration-500" />
          <div className="z-10 p-8 mt-8 sticky">
            <h3 className="text-[28px] font-semibold">
              Strategic Campaign{" "}
              <span className="text-purple-500">Planning</span>
            </h3>
            <p className="mt-3 text-lg text-white/70">
        ...
        >
          <p className="p-8 absolute z-10 bg-[#312727] -top-10 left-10 rounded-full">
            <Mails className="scale-150 text-purple-500 group-hover:text-yellow-400" />
          </p>
          <div className="absolute w-0 h-0 group-hover:w-full group-hover:h-full group-hover:bg-black rounded-tl-[30px] rounded-br-[30px] transition-all duration-500" />
          <div className="z-10 p-8 mt-8 sticky">
            <h3 className="text-[28px] font-semibold">
              Target <span className="text-purple-500">Audience</span>
            </h3>
            <p className="mt-3 text-lg text-white/70">
